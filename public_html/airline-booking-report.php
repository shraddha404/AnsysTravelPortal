...
<tr><td colspan="9"><span style="float:right; margin-bottom:10px; font-weight:bold; font-color:#43729f;"><a href="export-airline-booking-report.php">Export All</a></span></td></tr>
...
<th>Cost</th>
  ...
  <tbody>
    ...
    <tr>            <td align="center"><?php echo $request['id']; ?></td>
	<td align="center"><?php echo $request['firstname']." ".$request['middlename']." ".$request['lastname']; ?></td>   
	<td align="center"><?php $city=$u->getcity($request['travel_from']);echo $city['city_name']; ?></td> 
	<td align="center"><?php $cityto=$u->getcity($request['travel_to']);echo $cityto['city_name']; ?></td>     
      <td align="center"><?php echo $request['date']; ?></td>
      <td align="center"><?php echo $request['departure_time']; ?></td>     
<td align="center"><?php echo $request['meal_preference'];?></td>
