...
<select name="onwardcity[]" id="onwardcity"><option value=""><!--list to be populated dynamically-->From City</option>
		...
		<?php
		  ...
		  <?php
			...
			<p><label for "TO1" name="travel_to" id="travelto">Return City</label><select name="travel_to[]" id="travel_to" ><option value="">To city</option><?php
		    foreach($cities as $citie) { ?>
		      <option value="<?php echo $citie['id']; ?>"><?php echo $citie['city_name']; ?></option>
		  <?php
		    } ?> </select></p>
...
<input type="date" id="date" name="rdate[]" placeholder="Return date" autofocus /></p>
		...
		<?php
		  ...
		  <?php
			...
			<p><label for "air-pickup">Preferred Airline Time</label><select name="preferred_airline_time[]"><option value="">Sleect Airline Time</option> <option value="1">12:00am to 3:000am</option>      <option value="2">03:00am to 6:000am</option>      <option value="3">06:00am to 9:000am</option> <option value="4">9:00am to 12:000pm</option> <option value="5">12:00pm to 3:000pm</option> <option value="6">03:00pm to 6:000pm</option> <option value="7">06:00pm to 9:000pm</option> <option value="8">09:00pm to 12:000am</option>
		</select> </p>
...
<option value="">Select preferred car vendor co.</option>
		...
		<p><label for "car-co">Pick up City</label><input type="text" id="pickupcity" name="pickupcity[]" value="" readonly="readonly"></p><p><label for "air-pickup">Car type</label><input type="text" id="car_type" name="car_type[]" autofocus /><label for "air-pickup">Car size</label><input type="text" id="car_size" name="car_size[]" autofocus /></p></div></fieldset>
...
if (($('input[name=trip_type]:radio:checked').val())=="oneway") 
    //if ($('input[name=trip_type]:checked').val()) {
             {
//alert('hii');
               //document.getElementById("onward_city").innerHTML="To City";
        $('#onward_city').text('To City');
        $('#travelto').text('From City');
               //document.getElementById("travelto").innerHTML="From City";
             }
...
$(document).ready(function() {
   ...
   $('input[type="radio"]').click(function() {
	...
	document.getElementById("oneway1").innerhtml = 'From City';
	document.getElementById("oneway2").innerhtml = 'To City';
       }
       else {
       }
   });
