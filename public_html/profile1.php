...
<head><script src="//ajax.googleapis.com/ajax/
libs/jquery/1.8.1/jquery.min.js"></script><script>
...
<select name="city" id="city" ><option value="">City</option><?php $city=$u->getcity($user_profile['city']); 
 ...
 <p><label for "cell-no">Entity</label>
         <input type="text" id="entity" name="entity" placeholder="Entity" tabindex="12" value="<?php echo $user_profile['entity']; ?>" autofocus /></p>
    ...
    <!--/div-->
    <!--div class="col-6-grid clearfix"--><div class="tbBooks" id="tbBooks"> 
