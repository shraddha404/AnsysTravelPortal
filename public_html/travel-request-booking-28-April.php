...
<p><label for "from1">Pick up City</label><select name="pick_up_city"><option value=""><!--list to be populated dynamically-->Pick up City</option>
...
<?php
 ...
 </select> </p>	<p><label for "air-pickup">Pickup Location</label><input type="text" id="airport_pickup_loca" name="airport_pickup_loca[]" autofocus /></p>
