...
<div id="wrapper">
  ...
  <tbody>
    <tr>
      <td>Delhi</td><!--col elements should be editable if employee clicks on Amend plan-->
      <td>Pune</td>
      <td>11-4-17</td>
      <td>Air India</td>
      <td>Taj</td>
...
<div class="btn-set"> <input type="button" class="" value="Accpet Plan" /><input type="button" class="" value="Amend Plan" /></div>
