 ...
 <tr>
  ...
  <form id="travel-booking-plan" method="post" action="" enctype="multipart/form-data">
	...
	<tr>
          ...
          <td><?php if(empty($air_booking['travel_from'])){ }else{$city=$u->getcity($air_booking['travel_from']); echo $city['city_name'];}?></td>
...
<?php } #if ends for multicity ?>
	...
	<optioZn value="">Preferred hotel in the city</option>
	<?php $hoteldel=$u->gethotel($getdestdep['pref_hotel']); 
  	...
  	<?php
          ...
          <td><input type="checkbox" name="late_checkin" value="yes"></td>
          <td><input type="checkbox" name="late_checkout" value="yes"></td></tr><tr>
          <td> Late Checkin Date:<input type="date" id="date" name="late_checkin_date" placeholder="Check in date time" autofocus /></td>
          <td> Late Checkout Date:<input type="date" id="date" name="late_checkout_date" placeholder="Check Out date time" autofocus /></td>
          <td>Cost:<input type="text" name="cost" value=""></td>
		</tr>
	</tbody>
	</table>
