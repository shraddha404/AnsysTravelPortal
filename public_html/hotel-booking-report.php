...
$travel_requests = $u->getHotelbookingreport();
}
...
<tr><td colspan="11"><span style="float:right; margin-bottom:10px; font-weight:bold; font-color:#43729f;"><a href="export-hotel-booking-report.php">Export All</a></span></td></tr>
...
<th>Cost</th>
  ...
  <tbody>
	...
	<td align="center"><?php $hotel=$u->gethotel($request['hotel_id']);echo $hotel['hotel_`name']; ?></td> 
	<td align="center"><?php $hotel=$u->gethotel($request['hotel_id']);echo $hotel['address']; ?></td> 
