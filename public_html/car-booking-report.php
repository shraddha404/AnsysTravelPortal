...
$travel_requests = $u->getCarbookingreport();
}
...
<tr><td colspan="11"><span style="float:right; margin-bottom:10px; font-weight:bold; font-color:#43729f;"><a href="export-car-booking-report.php">Export All</a></span></td></tr>
...
<th>Cost</th>
  ...
  <tbody>
	...
	<td align="center"><?php echo $request['firstname']." ".$request['middlename']." ".$request['lastname']; ?></td>  
      ...
      <td align="center"><?php echo $request['type_of_vehicle']; ?></td>     
<td align="center"><?php echo $request['airport_drop'];?></td>
<td align="center"><?php echo $request['airport_pickup'];?></td>
	<td align="center"><?php $city=$u->getcity($request['from_location']);echo $city['city_name']; ?></td> 
      <td align="center"><?php echo $request['airport_drop_loca']; ?></td>
      <td align="center"><?php echo $request['pickup_time']; ?></td>
