...
<div id="wrapper">
  ...
  <div role="main">
  <div class="in-bloc cent row"><img src="img/to-fro.jpg" alt="Travel-plan-suggest" /><h1 class="in-bloc">Booking request ID<!-- dynamically pulled-->Suggested Plan</h1></div>
   <div class="row"><!--row begins-->
    <span class="f-leg"><img src="img/user32.png" />Approve</span>
    <table>
  <tr>
