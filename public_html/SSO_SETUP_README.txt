1. Copy simplesamlphp directory attached to this email to /var/www/html/ansys_travel_portal/public_html diretory.
2. Visit this url for Instructions -
http://www.lewisroberts.com/2015/09/05/single-sign-on-to-azure-ad-using-simplesamlphp/
3. Apache Configuration -
 Open /etc/apache2/sites-available/ansys_travel_portal

Add Line after 
ServerName ansysleave
and before DocumentRoot /var/www/html/ansys_travel_portal/public_html line
...
Alias /simplesaml /var/www/html/ansys_travel_portal/public_html/simplesamlphp/www
        DocumentRoot /var/www/html/ansys_travel_portal/public_html

        <Directory /var/www/html/ansys_travel_portal>
        ...
        ErrorLog ${APACHE_LOG_DIR}/ansys_travel_portal-error.log

        # Possible values include: debug, info, notice, warn, error, crit,
        # alert, emerg.
        LogLevel warn

        CustomLog ${APACHE_LOG_DIR}/ansys_travel_portal-access.log combined
</VirtualHost>
