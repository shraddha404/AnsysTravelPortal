...
$user_profile = $u->getUserDetails($_GET['id']);
$visaDetails = $u->getVisaDetailsByUserId($_GET['id']);
$getffDetails = $u->getffByUserid($_GET['id']);
  ...
  <form id="profile" method="post" action="" enctype="multipart/form-data">
	...
	<input type="hidden" name="user_type" value="<?php echo $user_profile['user_type'];?>">
  	<div class="row cent">
		...
		<h1 class="in-bloc">Employee profile</h1>
...
&nbsp;&nbsp;&nbsp;<a href='logout.php'>Logout</a></p></h3>
    ...
    <fieldset name "personal-info">
		...
		<p><label for "fname">First Name <font color="red">*</font></span></label>&nbsp; <?php echo $user_profile['firstname']; ?></p>
          	<p><label for "bunit">Business Unit <font color="red">*</font></label>&nbsp;<?php $bizunit=$u->getbus($user_profile['bu']);  echo $bizunit['bu_short_name'];?>
           	</p>
          	<p><label for "bunit">Organisation Unit <font color="red">*</font></label>&nbsp;<?php $orgunit=$u->getous($user_profile['ou']); echo $orgunit['ou_short_name'];?>
           	
           	
           	
           	
          	<p> <label for "home-add1">Home Address 1 </label>
           	&nbsp;<?php echo $user_profile['address1'];?></p> 
           	<p><label for "pincode">pincode </label>
           	&nbsp;<?php echo $user_profile['pincode']; ?></p>
           	<p><label for "Alt-no">Alternate Contact no. </label>
           	&nbsp;<?php echo $user_profile['alt_contact_no']; ?></p>         
         </div>
         
          <div class="col-3-grid">  <p><label for "mname">Middle Name </label>
         &nbsp;<?php echo $user_profile['middlename']; ?></p>
         <p><label for "off-loc">Office Location </label>&nbsp;<?php $location=$u->getoffice_locations($user_profile['location']);?><?php echo $location['location']; ?>
     </p>
         <p><label for "home-add2">Home Address 2 </label>
         &nbsp;<?php echo $user_profile['address2']; ?></p>
          <p><label for "email-id">Email add <font color="red">*</font></label>
         &nbsp;<?php echo $user_profile['email']; ?></p>
         <p><label for "emergency-no">Emergency Contact no. </label>
         &nbsp;<?php echo $user_profile['emergency_no']; ?></p></div>
         
          <div class="col-3-grid"><p><label for "lname">Last Name <font color="red">*</font></label>
         &nbsp;<?php echo $user_profile['lastname']; ?></p>
         <p><label for "bdate">Birthdate </label>
         &nbsp;<?php echo $user_profile['dob']; ?></p>
         <p><label for "city">City </label>&nbsp;<?php $city=$u->getcity($user_profile['city']); echo $city['city_name'];?></p> 
          <p><label for "cell-no">Contact no. <font color="red">*</font></label>
         &nbsp;<?php echo $user_profile['contact_no']; ?></p>
 <p><label for "cell-no">Manager Email</label>&nbsp;
        
<?php $manager_email=$u->getUserDetailsid($user_profile['manager']); echo  $user_profile['manager_email']; ?>
</p>
    ...
    <div class="col-3-grid">
        ...
        &nbsp;<?php echo $user_profile['passport_no']; ?></p>
    </div>
    <div class="col-3-grid">
        <p><label for "pp-exp-date">Passport expiry date </label>
        &nbsp;<?php echo $user_profile['passport_expiry_date']; ?></p>
    </div>
    <!--div class="col-3-grid">
...
<td align="center"><a href="uploads/visa-copy/<?php echo $visaDetail['visa_copy'];?>" target="_blank">View Visa Copy</a></td>
