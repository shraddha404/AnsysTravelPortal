...
<div id="wrapper">
  ...
  <form id="travel-booking" method="post" action="">
  	<div class="row cent clearfix">
	    <div class="in-bloc cent"><img src="img/bag.jpg" alt="profile creation" /><h1 class="in-bloc">Book your Hotel request</h1></div>
    </div>
    <!-- Travel details-->
    <div class="row">
...
<span class="f-leg"><img src="img/destination2.png" />Hotel details</span>
  ...
  <?php
      ...
      <div class="tbBooks1" id="tbBooks1"> 
       	<div class="col-3-grid">
	<p><label for "hotel">Preferred hotel</label><select id="pref_hotel" class="pref_hotel" name="pref_hotel[]"> 
