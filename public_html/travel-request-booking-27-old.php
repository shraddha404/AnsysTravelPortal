...
<?php
  ...
  <?php
   	...
   	<p><label for "air-co">Need Airport drop</label><input type="checkbox" name="airport_drop[]" value="yes"></p>
	<!--p><label for "air-drop">Airport Location</label--><input type="hidden" id="airport_drop_loca" name="airport_drop_loca[]" autofocus /><!--/p-->
</div>
...
<?php
  ...
  <?php
	...
	<p><label for "air-co">Need Airport pick up</label><input type="checkbox" name="airport_pickup[]" value="yes"></p>
...
<?php
  ...
  <?php
        ...
        <p><label for "air-co"> Need car for the entire day</label><input type="checkbox" name="need_car[]" value="yes"></p>	<p><label for "air-pickup">Preferred Airline Time</label><select name="preferred_airline_time"> <option value="1">12:00am to 3:000am</option>      <option value="2">03:00am to 6:000am</option>      <option value="3">06:00am to 9:000am</option> <option value="4">9:00am to 12:000pm</option> <option value="5">12:00pm to 3:000pm</option> <option value="6">03:00pm to 6:000pm</option> <option value="7">06:00pm to 9:000pm</option> <option value="8">09:00pm to 12:000am</option>
</select> </p>
</div></div>
  ...
  </div>  </div> <div id="container1" style="display:none;"> <div class="row">

   <!-- Destination and Departure details-->
<span class="f-leg"><img src="img/destination2.png" />Destination and departure details</span>
          	      <fieldset name "dest-dep"><div class="col-3-grid">
         	<p><label for "air-co">Select preferred Airlines</label>
<select name="book_airline[]"> 
...
<p><label for "air-co">Need Airport drop</label><input type="checkbox" name="airport_drop[]" value="yes"><br/>Location: <input type="text" id="airport_drop_loca" name="airport_drop_loca[]" autofocus /></p></p>
<p><label for "air-co">Need Airport pick up</label><input type="checkbox" name="airport_pickup[]" value="yes"><br/>Location: <input type="text" id="airport_pickup_loca" name="airport_pickup_loca[]" autofocus /></p>
            </div>
         	<div class="col-3-grid"><p><label for "dep-date1">Return Journey Date</label>
         	<input type="date" id="date" name="date[]" placeholder="Departure date" autofocus /></p>
             <p><label for "air-co"> Need car for the entire stay</label><input type="checkbox" name="need_car[]" value="yes"></p><p><label for "car-co">Select preferred car vendor co.</label><select name="car_company[]" id="car_company" class="car_company">
...
</select> </p><p><label for "air-pickup">Return Preferred Airline Time</label><select name="preferred_airline_time"> <option value="1">12:00am to 3:000am</option>      <option value="2">03:00am to 6:000am</option>      <option value="3">06:00am to 9:000am</option> <option value="4">9:00am to 12:000pm</option> <option value="5">12:00pm to 3:000pm</option> <option value="6">03:00pm to 6:000pm</option> <option value="7">06:00pm to 9:000pm</option> <option value="8">09:00pm to 12:000am</option>
</select> </p></fieldset></div></div>  <div id="container2" style="display:none;"></div> 
